  ...
  return (
    <div className="bg-linear-to-br from-[#0f1419] to-[#0b0f14] border border-foreground/10 rounded-2xl p-8 hover-glow transition-all duration-300">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-foreground">Payment Method (Stripe)</h2>
          </div>
          ...
          <div className="grid gap-4 max-w-2xl">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-foreground/5 border border-foreground/10 rounded-lg text-foreground placeholder:text-gray-500 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300"
              />
            </div>
