...
export function FightTable({ fights, selectedFightId, onSelectFight }: FightTableProps) {
    return (
                    ...
                    {fights.map((fight) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-6">
                                <p className="text-sm text-muted-foreground font-mono tracking-tight">{fight.odds}</p>
