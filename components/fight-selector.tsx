...
import FightSelectorPopover from "./fight-selector-popover"
...
const canAnalyze =
  ...
  return (
    <div className="relative rounded-3xl border border-foreground/30 bg-linear-to-br from-slate-900/95 via-slate-800/90 to-slate-900/95 backdrop-blur-2xl p-10 shadow-2xl shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-all duration-500 overflow-hidden">
      ...
      <div className="relative z-10 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
          ...
          <div className="space-y-3">
            <Label className="text-sm font-semibold text-foreground/90">Odds Source</Label>
            <div className="flex gap-2">
              <Button
                ...
                className={`flex-1 h-12 rounded-xl font-semibold transition-all duration-300 ${
                  oddsMode === "live"
                    ? "bg-linear-to-r from-cyan-500 via-blue-500 to-cyan-500 hover:from-cyan-600 hover:via-blue-600 hover:to-cyan-600 text-foreground shadow-lg shadow-cyan-500/50 border-0"
                    : "bg-slate-950/40 border border-foreground/20 text-gray-400 hover:bg-slate-900/60 hover:text-foreground hover:border-foreground/40"
                }`}
              >
              ...
              <div className="grid grid-cols-2 gap-3 mt-4 animate-expand">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="bg-slate-950/60 border-foreground/20 text-foreground placeholder:text-gray-600 text-sm h-10 rounded-lg focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/50 transition-all shadow-inner"
                  />
                </div>
                <div className="space-y-1.5">
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              disabled={!canAnalyze}
              size="lg"
              className="w-full bg-linear-to-r from-green-500 via-emerald-500 to-green-600 hover:from-green-600 hover:via-emerald-600 hover:to-green-700 text-foreground font-bold shadow-2xl shadow-green-500/60 disabled:opacity-30 disabled:cursor-not-allowed disabled:shadow-none h-12 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group border-0"
            >
              {/* Pulse animation overlay */}
              <div className="absolute inset-0 bg-linear-to-r from-green-400/0 via-foreground/20 to-green-400/0 translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
