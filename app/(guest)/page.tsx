...
export default function Page() {
  return (
    <div className="min-h-screen premium-bg overflow-hidden neural-bg font-sans selection:bg-primary/30 relative">
      ...
      <main className="container mx-auto px-4 py-24 relative z-10 flex flex-col items-center justify-center min-h-[80vh]">
        {/* Hero Section */}
        <HeroSection />
